...
//     }
  ...
  async function getStudInfo() {
    ...
    const responce = await CallAjax(`http://localhost:4050/getallvillages/${result[0]['']}`, {}, 'GET')
  ...
  async function registerstudents(teh) {
    const responce = await CallAjax(`http://localhost:4050/getallvillages/${teh}`, {}, 'GET')
...
<div class="-mx-3 flex flex-wrap">
  ...
  <div class="mb-5">
              <label for="date" class="mb-3 block text-base font-medium text-[#07074D]">
                Date of Birth 1 {moment(val.stude_dob).format('YYYY-MM-DD')}
              </label>
  ...
  <div class="mb-5">
              ...
              <input type="date" name="admition" id="date" 
                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-blue-400 focus:shadow-md" />
            </div>
  </div>
            ...
            <div class="mb-5 pt-3">
              ...
              <div class="-mx-3 flex flex-wrap">
                ...
                <div class="w-full px-3 sm:w-1/2 mt-auto ">
                  <div class="mb-5">
                    <div class="flex justify-center">
                    <div class={`rounded-md bg-gradient-to-r from-blue-700 to-blue-500 px-11 py-3 text-white hover:from-blue-800 hover:to-white-500 ${selectedValue ? 'cursor-pointer' : 'cursor-not-allowed'}`} onClick={selectedValue ? openModal : ''}>
                        Add
                      </div>
                    </div>
                  </div>
